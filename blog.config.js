...
const BLOG = {
  ...
  THEME_SWITCH: process.env.NEXT_PUBLIC_THEME_SWITCH || tuer, // 是否显示切换主题按钮
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是小鲨鱼, 你想愉快畅玩全球App？找我就对啦！欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小鲨鱼', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '微信：Ftshayu', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ftshayu.buzz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '小鲨鱼教程中心', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '备案号 韩国首尔ICP备12367888', // 备案号 闽ICP备XXXXXXX
  ...
  COMMENT_GITALK_REPO: process.env.NEXT_PUBLIC_COMMENT_GITALK_REPO || '鲨鱼Studio', // 你的Github仓库名，例如 'NotionNext'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '小鲨鱼工作室', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是由鲨鱼Studio创建并生成的站点', // 站点描述，被notion中的页面描述覆盖
